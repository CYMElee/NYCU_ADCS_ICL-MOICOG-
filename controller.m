classdef controller
    properties
         ...
         gamma =  diag([0.00000000000001,0.00000000000001,0.00000000000001,0.00000000000001,0.00000000000001,0.00000000000001,0.00000001,0.00000001,0.00000001]);

         c2 = 1.5
        %% ICL
        Y_icl_last = zeros(3,9,30);
        M_icl_last = zeros(3,30);
        ...
        k_icl =  diag([500000000000000,500000000000000,500000000000000,500000000000000,500000000000000,500,50,50,50]);
